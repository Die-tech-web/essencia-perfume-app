...
const categories = [
  {
    ...
    description: "Good Girl, J'adore et La Vie Est Belle pour une féminité affirmée.",
  ...
  },
  {
    ...
    description: "Sauvage, Bleu de Chanel et Oud Wood pour une signature élégante.",
  ...
  },
  {
    ...
    description: "Des sélections premium autour de Chanel N°5 et des grands classiques.",
